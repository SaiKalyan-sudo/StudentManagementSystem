...
public class Staff_login extends Frame implements ActionListener 
{
    Frame f;
    Label l1,l2,l3;
    TextField t1,t2;
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if(e.getSource()==b1)
        {
            ...
            s1="select * from Staffdetails";
            r1=s.executeQuery(s1);
            while(r1.next())
            {
                dbpass=r1.getString(3);
                dbname=r1.getString(2);
                
                if(name.equals(dbname)&& roll.equals(dbpass))
                {
